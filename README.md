# cocos2d-unblock
 cocos2d-x é um framework multiplataforma para construção de jogos 2D, livros interativos, demos e outras aplicações gráficas. É baseado em cocos2d-iphone , mas em vez de usar Objective-C, usa C++. Funciona em iOS, Android, macOS, Windows e Linux<img src="http://www.cocos2d-x.org/attachments/801/cocos2dx_portrait.png" width=200>
